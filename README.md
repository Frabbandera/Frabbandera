...
MSc student in Music and Acoustic Engineering at Politecnico di Milano, with a BSc background in Energy Engineering.

I focus on acoustic simulation, numerical modelling, vibroacoustics/NVH, vehicle cabin acoustics, room acoustics, acoustic measurements, and machine-learning workflows for acoustic/audio data.

My GitHub portfolio collects selected academic and technical projects related to acoustic engineering, simulation workflows, validation-oriented modelling, and applied signal/data analysis.

## Technical Areas

- Acoustic simulation and numerical modelling
- Vehicle cabin acoustics and NVH analysis
- FEM-based wave-propagation modelling
